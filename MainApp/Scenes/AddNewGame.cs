...
public sealed class AddNewGame : IScene
{
    public IScene Execute()
    {
        ...
        return new MainMenu(lang: _lang, logger: _logger, gameLibrary: _gameLibrary, appState: _appState);
    }

    public AddNewGame(LanguageManager lang, Logger logger, GameLibrary gameLibrary, AppState appState)
    {
        _lang = lang;
        _logger = logger;
