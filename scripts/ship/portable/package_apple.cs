...
var shipComponentDir = Path.Combine(rootDir, "out", "ship", "portable", "apple");
...
var archivePath = Path.Combine(archiveOutputDir, "GameWatch.Cli.Apple.Portable.Package.zip");
