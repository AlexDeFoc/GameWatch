...
var shipComponentDir = Path.Combine(rootDir, "out", "ship", "portable", "windows_x64");
...
var archivePath = Path.Combine(archiveOutputDir, "GameWatch.CliSuite-Windows-x64.zip");
