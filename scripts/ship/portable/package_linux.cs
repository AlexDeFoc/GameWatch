...
var shipComponentDir = Path.Combine(rootDir, "out", "ship", "portable", "linux");
...
var archivePath = Path.Combine(archiveOutputDir, "GameWatch.Cli.Linux.Portable.Package.zip");
