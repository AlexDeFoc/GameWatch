...
var portableBaseDir = Path.Combine(rootDir, "out", "ship", "portable", "windows_x64", "GameWatch");
var archiveFile = Path.Combine(rootDir, "out", "ship", "portable", "archives", "GameWatch.CliSuite-Windows-x64.zip");
