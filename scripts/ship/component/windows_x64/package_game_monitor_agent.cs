...
var shipComponentDir = Path.Combine(rootDir, "out", "ship", "component", "windows_x64"); 
var shippedDir = Path.Combine(shipComponentDir, "Agents", "GameMonitor");

var archiveOutputDir = Path.Combine(rootDir, "out", "ship", "component", "windows_x64", "Archives");
var archivePath = Path.Combine(archiveOutputDir, "GameWatch.Agent.GameMonitor-Windows-x64.zip");
