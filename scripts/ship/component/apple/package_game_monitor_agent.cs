...
var shipComponentDir = Path.Combine(rootDir, "out", "ship", "component", "apple"); 
var shippedDir = Path.Combine(shipComponentDir, "Agents", "GameMonitor");

var archiveOutputDir = Path.Combine(rootDir, "out", "ship", "component", "apple", "Archives");
var archivePath = Path.Combine(archiveOutputDir, "GameWatch.Agent.GameMonitor.Component.tar.gz");
