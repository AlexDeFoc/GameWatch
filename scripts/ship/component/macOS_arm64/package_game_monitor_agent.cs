...
var shipComponentDir = Path.Combine(rootDir, "out", "ship", "component", "macOS_arm64"); 
var shippedDir = Path.Combine(shipComponentDir, "Agents", "GameMonitor");

var archiveOutputDir = Path.Combine(rootDir, "out", "ship", "component", "macOS_arm64", "Archives");
var archivePath = Path.Combine(archiveOutputDir, "GameWatch.Agent.GameMonitor-macOS-arm64.tar.gz");
