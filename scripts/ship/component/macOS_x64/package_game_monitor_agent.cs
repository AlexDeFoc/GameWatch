...
var shipComponentDir = Path.Combine(rootDir, "out", "ship", "component", "macOS_x64"); 
var shippedDir = Path.Combine(shipComponentDir, "Agents", "GameMonitor");

var archiveOutputDir = Path.Combine(rootDir, "out", "ship", "component", "macOS_x64", "Archives");
var archivePath = Path.Combine(archiveOutputDir, "GameWatch.Agent.GameMonitor-macOS-x64.tar.gz");
