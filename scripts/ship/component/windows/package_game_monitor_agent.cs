...
var shipComponentDir = Path.Combine(rootDir, "out", "ship", "component", "windows"); 
var shippedDir = Path.Combine(shipComponentDir, "Agents", "GameMonitor");

var archiveOutputDir = Path.Combine(rootDir, "out", "ship", "component", "windows", "Archives");
var archivePath = Path.Combine(archiveOutputDir, "GameWatch.Agent.GameMonitor.Component.zip");
