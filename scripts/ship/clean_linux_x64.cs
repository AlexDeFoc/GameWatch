...
var portableBaseDir = Path.Combine(rootDir, "out", "ship", "portable", "linux_x64", "GameWatch");
var archiveFile = Path.Combine(rootDir, "out", "ship", "portable", "archives", "GameWatch.CliSuite.Linux-x64.zip");
